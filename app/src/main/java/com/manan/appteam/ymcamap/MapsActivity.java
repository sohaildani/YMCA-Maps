...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        MarkerOptions defaultMarker =new MarkerOptions().position(nitDelhi).title("YMCA University of Science and Technology").snippet("Elements Culmyca'17").icon(BitmapDescriptorFactory.fromResource(R.drawable.loc));
